...
comm1 = utils.sha3(bytes(tohash))
print("Player zero chooses {} which is: {}".format(choice1, choice[choice1]))

choice2 = 0
nonce2 = 1
ch2 = bytearray(utils.int_to_32bytearray(choice2))
no2 = bytearray(utils.int_to_32bytearray(nonce2))
tohash = bytearray().join([bytearray(12), tester.a1, ch2, no2])
comm2 = utils.sha3(bytes(tohash))
...
o = c.open(choice1, nonce1, sender=tester.k0)
print("Open for player 0: {}".format(o))

o = c.open(choice2, nonce2, sender=tester.k1)
